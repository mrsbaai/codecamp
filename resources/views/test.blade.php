            ...
            <div class="row h-100">
                <div class="col-12">
                    <div class="text-center m-0 vh-100 d-flex flex-column justify-content-center text-light">
                        <h1 class="display-4">Signal</h1>
                        <p class="lead">Like sailing yacht flags in a busy harbor.</p>
                        <div class="row">
        ...
        <section class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="pb-3">
                            <button type="button" class="btn btn-primary mr-1">Primary #FF304F</button>
