...
<head>
  ...
  <meta name="msapplication-TileImage" content="/construction/img/favicon/ms-icon-144x144.png">
      ...
      <p>
        ...
        <blockquote class="blockquote">
          <h1 style="color:white">
            ...
            <br/>
            <b><span class="typed" data-typed-items="التكوين الأساسي الذي يحتاجه كل شخص يمتلك..., تجارة, منتج, خدمة, علامة تجارية, ويتطلع إلى ترويجها على الإنترنت, وتطوير نشاطه التجاري"></span></b>
          ...
          <br/> <br/>
            <div class="img-fluid text-white pt-4 text-center">
              <br/><br/><h3 class="text-justify">
                <b>	&#10003; </b> ستتعلم كيفية إنشاء وإعداد مدير أعمال فيسبوك بحيث تستطيع إدارة صفحاتك وحساباتك الإعلانية.
              </h3><br/><h3 class="text-justify"><b>	&#10003; </b> ستتعلم كيفية إنشاء حسابات إدارة الإعلانات وستفهم هيكلية الحملات الإعلامية بحيث تستطيع تشغيل إعلانات مستهدفة وذكية.

              </h3><br/><h3 class="text-justify"><b>	&#10003; </b> سيصبح لديك فهم دقيق لجمهورك بحيث تستهدفهم بإعلانات جذابة لا تخطئها العين، الشيء الذي سيعود عليك بنتائج ومكاسب سريعة.



              </h3><br/><h3 class="text-justify"><b>	&#10003; </b> ستتعلم كيفية تحليل نتائج الحملات الإعلانية بشكل ذكي وفعال، بحيث تستطيع الاستمرار في تطوير ورفع مردودية حملتك الإعلانية.
...
<br/>
          ...
          <p class="lead">
            ...
            <h1>التسجيل:</h1>
            <br/>
            <h3> (سعر التذكرة 190 درهم) نود إبلاغكم أن المقاعد محدودة. للحصول على تذكرة ،يرجى تعبئة الطلب التالي:</h3>
          </p>
          <br/><br/>
